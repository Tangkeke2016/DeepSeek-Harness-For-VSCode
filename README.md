...
1. 从 [Releases](https://github.com/Tangkeke2016/DeepSeek-Harness-For-VSCode/releases) 下载 `tangkeke-deepseek-harness-0.1.6.vsix`。
...
选择“跟随 VS Code”时，会话背景使用当前 VS Code 编辑器背景色，并随主题切换实时更新；手动选择浅色或深色仍使用官方配色。
